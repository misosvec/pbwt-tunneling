...
visualize_haplotypes_sizes:
	for i in 5000 50000 100000 200000 500000 1000000; do \
		make generate_haplotypes SAMPLE_SIZE=10000 REGION_IN_BASE_PAIRS=$${i} OUTPUT_FILE=haplotypes_$${i}.txt && \
		...
		bzip2 -k haplotypes_$${i}.txt && \
        bzip2 -k haplotypes_encoded_$${i}.txt; \
	done
